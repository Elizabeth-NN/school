...
const footerLinks = [
  ...
  },
  {
    title: 'Contact',
    links: [
      { name: 'Email: info@greenwood.edu', href: 'mailto:info@greenwood.edu' },
      { name: 'Phone: (555) 123-4567', href: 'tel:5551234567' },
      { name: 'Address: 123 School St, City', href: '#' },
    ],
  },
];
    ...
    <footer className="bg-gray-800 text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
          ...
          <div>
            <Link href="/" className="flex items-center mb-4">
              <Image
                ...
                className="mr-3"
              />
              <span className="text-xl font-bold">Greenwood High</span>
            </Link>
        ...
        <div className="border-t border-gray-700 pt-6 text-center text-gray-400">
          <p>
            © {new Date().getFullYear()} Greenwood High School. All rights
            reserved.
          </p>
        </div>
      </div>
